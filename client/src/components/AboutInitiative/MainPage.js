...
class MainPage extends Component {
    ...
    <Grid container spacing={24}>
        <Grid item xs={2}>
        <About img={x.aa.img} name={x.aa.name}  content={x.aa.content} />
        </Grid>
        <Grid item xs={2}>
        <About img={x.zk.img} name={x.zk.name} content={x.zk.content}/>
        </Grid>
        <Grid item xs={2}>
        <About img={x.qra.img} name={x.qra.name} content={x.qra.content} />
        </Grid>
        <Grid item xs={2}>
        <About img={x.hl.img} name={x.hl.name} content={x.hl.content}/>
        </Grid>
        <Grid item xs={2}>
        <About img={x.sm.img} name={x.sm.name} content={x.sm.content}/>
        </Grid>
        </Grid>
        </div>
        );
