        ...
        return ( 
          ...
          <h1 onClick={() => {
            ...
            <div className="row" style={{marginTop: 50}}>
              ...
              <p>Navigation</p>
                <ul>
                  <li onClick={() => {this.props.history.push("artificialinteligence")}} className="truncate">Artificial Intelligence</li>
                  <li onClick={() => {this.props.history.push("cloudnative")}}>Cloud Native</li>
